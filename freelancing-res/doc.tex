...
Per attivit\'a legate allo sviluppo software o legate all'informatica, la divisione di riferimento \'e la 62 e la 63. I possibili codici ateco legati a questa attivit\'a sono:
\begin{itemize}
    \item 62.01: Produzione di software non connesso all'edizione
    \item 62.09.01: Configurazione di personal computer
    \item 62.09.09: Altre attivit\'a dei servizi connessi alle tecnologie dell'informatica n.c.a.
\end{itemize}
In particolare con il codice ateco 62.01 si intende l'attivit\'a di Produttore di software non connesso all'edizione, ovvero: Attivit\'a di scrittura, modifica, verifica, documentazione e assistenza di software; progettazione della struttura e dei contenuti e/o compilazione dei codici informatici
necessari per la creazione e implementazione di: software di sistema, applicazione di software database, pagine web e personalizzazione di software.
